...
const benefits = [
  ...
  },
  {
    ...
    desc: "Osim za opšte zdravlje, Kremanska voda čini blagodeti i za našu kožu i kosu.",
    ...
    <section id="benefits" className={styles.section} ref={ref}>
      <div className="container-custom">
        <div className={styles.header}>
          ...
          <h2 className={styles.title}>Zašto birati <span className={styles.accent}>Kremansku</span></h2>
        </div>
        <div className={styles.grid}>
          {benefits.map((b, i) => (
            <a key={b.title} href={b.link} target="_blank" rel="noopener" className={styles.card} style={{ animationDelay: `${i * 0.15}s` }}>
