      ...
      <div className="container-custom relative z-10">
        ...
        <div className={styles.bentoMosaic}>
          ...
          <div className={`${styles.bentoItem} ${styles.videoSlot} ${isVisible ? styles.revealItem : ""}`}>
             ...
             <div className={styles.slotTag}>Tara National Park</div>
          </div>

          {/* Narrative Pillar: Nasleđe (Tall) */}
          <div className={`${styles.bentoItem} ${styles.textSlot} ${isVisible ? styles.revealItem : ""}`} style={{ transitionDelay: '0.2s' }}>
             <div className={styles.pillarContent}>
                <span className={styles.pillarBadge}>Nasleđe</span>
                <h3>Proročanstvo <br />Tarabića</h3>
                <p>
          ...
          <div className={`${styles.bentoItem} ${styles.factSlot} ${isVisible ? styles.revealItem : ""}`} style={{ transitionDelay: '0.3s' }}>
          ...
          <div className={`${styles.bentoItem} ${styles.ecoSlot} ${isVisible ? styles.revealItem : ""}`} style={{ transitionDelay: '0.4s' }}>
             <div className={styles.mediaContainer}>
